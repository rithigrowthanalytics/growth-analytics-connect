  ...
  const founders = [
    {
      ...
      bio: "Sid brings over 20 years of experience working across analytics, growth and M&A functions. He works as a CRO and has built an amazing team within growth analytics to support customers with their build and buy decisions in addition to building and taking three AI applications to market to date.",
